    ...
    <footer id="contact" className="relative py-24 px-8 lg:px-16 bg-transparent border-t-[6px] border-squid-pink overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row justify-between items-center gap-12">
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="flex items-center gap-3 mb-3">
            <img
              src="/scyp_logo.png"
              alt="SCYP Club Logo"
              className="w-11 h-11 rounded-full object-cover border-2 border-cyan-500/60 shadow-[0_0_10px_rgba(0,200,255,0.35)]"
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="text-gray-150 text-[9px] tracking-[0.15em] font-semibold uppercase">
        ...
        <div className="flex gap-4">
          <a href="https://chat.whatsapp.com/GmarnlAWX5GLZhdOe1aRL0?s=cl&p=a&mlu=2" className="w-11 h-11 rounded-full border border-gray-800 bg-black flex items-center justify-center text-gray-400 hover:text-white hover:border-squid-pink hover:bg-squid-pink/10 transition-all shadow-lg" aria-label="WhatsApp">
          ...
          <a href="https://www.instagram.com/sage_scyp?igsh=MTNrNTV3eHIzZDliaA==" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full border border-gray-800 bg-black flex items-center justify-center text-gray-400 hover:text-white hover:border-squid-pink hover:bg-squid-pink/10 transition-all shadow-lg" aria-label="Instagram">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://www.linkedin.com/company/scyp-student-council-yantriki-panchtatva/about/?viewAsMember=true" className="w-11 h-11 rounded-full border border-gray-800 bg-black flex items-center justify-center text-gray-400 hover:text-white hover:border-squid-pink hover:bg-squid-pink/10 transition-all shadow-lg" aria-label="LinkedIn">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">

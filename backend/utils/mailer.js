...
/**
 * Creates a Nodemailer transporter from environment SMTP credentials.
 * Supports Gmail (with App Password), Outlook, or any SMTP service.
 */
  ...
  const htmlBody = isApproved
    ? `
      <div style="font-family:sans-serif;background:#0a0a0a;color:#ffffff;padding:40px;max-width:600px;margin:auto;border:1px solid #f9004d;">
        ...
        <p style="font-size:14px;color:#aaa;">Congratulations, <strong style="color:#fff">${leaderName}</strong>!</p>
        <p style="font-size:14px;color:#aaa;">Your team <strong style="color:#f9004d">${teamName}</strong> has been <strong style="color:#22c55e">VERIFIED & APPROVED</strong> as an official SquidHack 2026 Finalist.</p>
        <div style="background:#111;border:1px solid #f9004d22;padding:16px;margin:24px 0;border-radius:4px;">
          <p style="margin:0;font-size:12px;color:#888;text-transform:uppercase;letter-spacing:2px;">Team ID</p>
          <p style="margin:4px 0 0;font-size:20px;color:#f9004d;font-weight:bold;letter-spacing:3px;">${teamId}</p>
        </div>
        <p style="font-size:14px;color:#aaa;">📅 <strong style="color:#fff">Event Date:</strong> August 1st, 2026</p>
        <p style="font-size:14px;color:#aaa;">📍 <strong style="color:#fff">Venue:</strong> SAGE University, Indore</p>
        <hr style="border-color:#1a1a1a;margin:24px 0;" />
        <p style="font-size:12px;color:#555;">Outplay. Outcode. Survive. — Team SquidHack</p>
      </div>
    `
    : `
      <div style="font-family:sans-serif;background:#0a0a0a;color:#ffffff;padding:40px;max-width:600px;margin:auto;border:1px solid #333;">
        <h1 style="color:#f9004d;font-size:28px;letter-spacing:4px;text-transform:uppercase;margin-bottom:4px;">SQUID HACK 2026</h1>
        <p style="color:#888;font-size:11px;letter-spacing:3px;text-transform:uppercase;margin-top:0;">Registration Status Update</p>
        <hr style="border-color:#1a1a1a;margin:24px 0;" />
